<style>
    ...
    .title-stats.title-skyblue {
        background-color: #00acd6;
    }

    .title-stats.title-red {
    ...
    .title-stats.title-pink {
        background-color: #E91E63;
    }

    .title-stats.title-cyan {
        background-color: #00BCD4;
    }

    .title-stats.title-orange {
        background-color: #FF9800;
    }

    .title-stats.title-purple {
    ...
    .title-stats.title-indigo {
        background-color: #3F51B5;
    }

    .title-stats.title-blue:hover {
        background-color: #00639e;
    }

    .title-stats.title-green:hover {
        background-color: #008d4c;
    }

    .title-stats.title-skyblue:hover {
        background-color: #009AC0;
    }

    .title-stats.title-red:hover {
        background: #f4543c;
    }

    .title-stats.title-gray:hover {
        background-color: #7C6235;
    }

    .title-stats.title-pink:hover {
        background-color: #bd0846;
    }

    .title-stats.title-cyan:hover {
        background-color: #058696;
    }

    .title-stats.title-orange:hover {
        background-color: #d88305;
    }

    .title-stats.title-purple:hover {
    ...
    .title-stats.title-indigo:hover {
    ...
    .panel.admin.top-reference-area {
        margin-top: 0;
    }
    ...
    #sidebar-menu ul.profile ul.profile-submenu {
        margin-top: 10px;
    }

    #sidebar-menu ul.profile ul.profile-submenu li a {
        padding: 10px 10px
    }
    ...
    #sidebar-menu ul.components ul li a:hover {
        background-color: rgb(165, 27, 27, 0.9);
    }

    .list-unstyled.submenu li {
        background-color: #be2e2e8a;
    }
    ...
    .add-back-btn:hover,
    .add-newProduct-btn:hover,
    .add-product_btn:hover,
    ...
    .add-product-box .form-horizontal {
        padding: 20px 0;
    }

    .add-product-box .form-horizontal .form-group {
        margin-bottom: 20px;
    }
    ...
    .add-product-box>.form-horizontal label {
        font-size: 16px;
    }
    ...
    .table-responsive.order-details-table {
        padding: 20px;
    }
    ...
    .qualification-area,
    .color-area,
    .single-color .qualification-area-open {
        position: relative;
    }
    ...
    .profile-info.dropdown a[aria-expanded="true"]::before {
        display: none;
    }
    ...
    .invoice__table .table>tfoot>tr:first-child>td {
    ...
    .invoice__table .table>tfoot>tr:last-child>td:first-child {
        border: none;
    }
    ...
    .modal.vendor .form-group {
        margin-bottom: 24px;
    }

    /*----------Ending of Vendor shop area----------*/

    / New CSS / .support-ticket-wrapper .panel-body img {
        height: 60px;
        width: 60px;
        border-radius: 100%;
    }
