...
.invoice__metaInfo {margin-top: 0px;}
...
.invoice__orderDetails {margin: 8px 0;}
.invoice__orderDetails p strong,
.invoice__shipping p strong {
    margin-bottom: 10px; 
    display: block;
            ...
            <div>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <a style="color: white;" href="{{ route('front.checkout', ['abandonment' => "abandonment"]) }}">
                            <button type="button" class="btn btn-success">Retornar ao Checkout</button>
                        </a>
                    </div>
                </div>
        </div>
