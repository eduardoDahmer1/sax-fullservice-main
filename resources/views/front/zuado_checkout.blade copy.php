...
<script src="{{ asset('assets/checkout/scripts.js') }}"></script>
            ...
            <div class="col-lg-8">
                ...
                <div class="preloader" id="preloader_checkout" style="background: url({{ $gs->loaderUrl }}) no-repeat scroll center center;
            background-color: rgba(0,0,0,0.5);
            display: none">
                </div>

                <form id="myforms" action="/test" method="POST" class="checkoutform">
                    @include('includes.form-success')
                    @include('includes.form-error')
                    {{ csrf_field() }}
                                        ...
                                        <div class="billing-address">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <!-- Date -->
                                                    <div class="col-lg-6">
                                                        <input placeholder="{{ __('Date of Birth') }}"
                                                            class="form-control"
                                                            value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->birth_date : old('birthday') }}"
                                                            type="text" id="birthday" name="birthday" required />
                                                    </div>
                                                    ...
                                                    <div>
                                                        <select class="form-control" name="customer_gender"
                                                            ...
                                                            <option value="M" {{ old('customer_gender')=='M'
                                                                ? 'selected' : '' }}> {{ __("Male") }}</option>
                                                            <option value="F" {{ old('customer_gender')=='F'
                                                                ? 'selected' : '' }}>{{ __("Female") }}</option>
                                                            <option value="O" {{ old('customer_gender')=='O'
                                                                ? 'selected' : '' }}>{{ __("Other") }}</option>
                                                            <option value="N" {{ old('customer_gender')=='N'
                                                                ? 'selected' : '' }}>{{ __("Not Declared") }}</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <input class="form-control" type="text" name="email"
                                                            id="billEmail" placeholder="{{ __('Email') }} *" required=""
                                                            value="{{ session()->get('session_order')['customer_email'] }}">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div>
                                                        <select class="form-control js-country" name="country"
                                                            ...
                                                            <option value="{{ $country->id }}" {{ session()->
                                                                get('session_order')['customer_country_id'] ==
                                                                $country->id ? 'selected' : '' }}
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <input class="form-control ship_input" pattern="^(\S*)\s+(.*)$"
                                                        ...
                                                        __('Input first name and last name') }}
                                                        placeholder="{{ __('Full Name') }} *"
                                    ...
                                    <div class="billing-address">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-12 p-0 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input class="form-control" type="text" name="customer_document"
                                                        id="billCpf" placeholder="{{ __('Document') }}*" required=""
                                                ...
                                                <div class="col-lg-6">
                                                    <input class="form-control" type="text" name="cpf_brasileiro"
                                                        id="cpf_brasileiro" placeholder="{{ __('RUC') }}"
                                                        pattern="[0-9]+" title="{{ __('Field only accepts numbers') }}">
                                                </div>
                                                ...
                                                <!-- Data -->
                                                <div class="col-lg-6">
                                                    <input placeholder="{{ __('Date of Birth') }}" class="form-control"
                                                        value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->birth_date : old('birthday') }}"
                                                        type="text" id="birthday" name="birthday" required />
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <select class="form-control" name="gender" id="gender">
                                                        ...
                                                        <option value="O" {{ old('gender')=='O' ? 'selected' : '' }}>{{
                                                            __("Other") }}</option>
                                                        <option value="N" {{ old('gender')=='N' ? 'selected' : '' }}>{{
                                                            __("Not Declared") }}</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <select class="form-control js-country" name="country"
                                                        ...
                                                        <option value="" data-code="">{{ __('Select Country') }}
                                                            *</option>
                                                        @foreach ($countries as $country)
                                                        <option value="{{ $country->id }}" {{ Auth::guard('web')->
                                                            check() && Auth::guard('web')->user()->country_id ==
                                                            $country->id ? 'selected' : '' }}
                                                            data-code="{{ $country->country_code }}">
                                                            {{ $country->country_name }}</option>
                                                        @endforeach
                                    ...
                                    <div class="order-area">
                                        ...
                                        <div class="order-item">
                                            <div class="product-img">
                                                <div class="d-flex">
                                                    <img src="{{ filter_var($product['item']['photo'], FILTER_VALIDATE_URL)
                                                        ...
                                                        alt="product" height="80" width="80" class="p-1">
                                                </div>
                                            </div>
                                            <div class="product-content">
                                                ...
                                                env('ENABLE_CUSTOM_PRODUCT_NUMBER'))
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="pay-area d-none">
                                                    <div class="tab-content {{ $gs->is_bancard == 1 ? ' d-none' : '' }} "
                                                        ...
                                                        <div class="tab-pane fade" id="v-pills-tab14" role="tabpanel"
                                                            aria-labelledby="v-pills-tab14-tab">
                                                        </div>
                ...
                <div class="order-box">
                    ...
                    <ul class="order-list">
                        ...
                        <li class="discount-bar">
                            ...
                            <P>
                                ...
                                <b id="discount">{{ $curr_checkout->sign }}{{ number_format(
                                    Session::get('coupon'),
                    ...
                    <div class="total-price">
                        ...
                        <p style="margin-bottom:0px;">
                            @if (Session::has('coupon_total'))
                            @if ($gs->currency_format == 0)
                            <span id="total-cost">{{ $curr_checkout->sign }}{{ number_format(
                                $totalPrice,
                                $curr_checkout->decimal_digits,
                                $curr_checkout->decimal_separator,
                                $curr_checkout->thousands_separator,
                            ...
                            @else
                            <span id="total-cost">{{ number_format(
                                $totalPrice,
                                $curr_checkout->decimal_digits,
                                $curr_checkout->decimal_separator,
                                $curr_checkout->thousands_separator,
                    ...
                    <div class="final-price">
                        ...
                        @if (Session::has('coupon_total'))
                        @if ($gs->currency_format == 0)
                        <span id="final-cost">{{ $curr_checkout->sign }}{{ number_format(
                            $totalPrice,
                            $curr_checkout->decimal_digits,
                            $curr_checkout->decimal_separator,
                            $curr_checkout->thousands_separator,
                        ...
                        @else
                        <span id="final-cost">{{ number_format(
                            $totalPrice,
                            $curr_checkout->decimal_digits,
                            $curr_checkout->decimal_separator,
                            $curr_checkout->thousands_separator,
...
<script>
    ...
    $('.js-country').change(function (e, zipdata) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (zipdata) {
                    $('#' + select_state).html('<option value="' + zipdata['state_id'] + '">' +
                        zipdata['state_name'] + '</option>').trigger('change', zipdata);
                } else {
                    $('#' + select_state).html(
    ...
    $('.js-state').change(function (e, zipdata) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (zipdata) {
                    $('#' + select_city).html('<option value="' + zipdata['city_id'] + '">' +
                        zipdata['city'] + '</option>').trigger('change');
                } else {
                    $('#' + select_city).html(
                        '<option value="">{{ __('Select City') }}</option>');
                }
