...
@section('content')
    ...
    <section class="checkout">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="preloader" id="preloader_checkout"
                        style="background: url({{ $gs->loaderUrl }}) no-repeat scroll center center;
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 d-none">
                                                        <select class="form-control" id="shipop" name="shipping"
                                                            ...
                                                            <option value="pickup" selected>{{ __('Pick Up') }}</option>
                                                        </select>
                                                    </div>
        ...
        @if ($digital == 0)
            ...
            <div class="shipping-area-class d-none" id="shipping-area">
            ...
            <div class="packeging-area d-none">
...
@section('scripts')
    ...
    <script>
        ...
        @if (!Auth::check() && !Session::has('session_order')) $('.js-country').val(''); @endif
