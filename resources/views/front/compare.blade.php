                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-price c{{$product['item']['id']}}">
                                            {{ App\Models\Product::find($product['item']['id'])->showPrice() }}</td>
                                        @endforeach
                                    </tr>
                                    @if($gs->is_rating == 1)
                                    <tr>
                                        ...
                                        <td class="pro-ratting c{{$product['item']['id']}}">
                                            <div class="ratings">
                                                ...
                                                <div class="full-stars"
                                                    style="width:{{App\Models\Rating::ratings($product['item']['id'])}}%">
                                                </div>
                                            </div>
                                        </td>
                                        @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <td class="c{{$product['item']['id']}}">
                                            ...
                                            <a href="{{ route('affiliate.product', $product['item']['slug']) }}"
                                                class="btn__bg">{{ __("Buy Now") }}</a>
                                            @else

                                            <a href="javascript:;"
                                                data-href="{{ route('product.cart.add',$product['item']['id']) }}"
                                                class="btn__bg add-to-cart">{{ __("Add To Cart") }}</a>
                                            <a href="{{ route('product.cart.quickadd',$product['item']['id']) }}"
                                                class="btn__bg">{{ __("Buy Now") }}</a>
                                            @endif
                                        </td>
                                        @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <td class="pro-remove c{{$product['item']['id']}}">
                                            <i class="far fa-trash-alt compare-remove"
                                                data-href="{{ route('product.compare.remove',$product['item']['id']) }}"
                                                data-class="c{{$product['item']['id']}}"></i>
                                        </td>
                                        @endforeach
                                    </tr>
                                </tbody>
