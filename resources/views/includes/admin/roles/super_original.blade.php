<li>
    <a href="#order" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
    ...
    <ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
        ...
        <li>
            <a href="{{route('admin-order-simplified-checkout')}}"> {{ __('Simplified Checkout') }}</a>
        </li>
    </ul>
</li>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('admin-prod-index', 'active') }}"><span>{{ __('Active Products') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-index', 'inactive') }}"><span>{{ __('Inactive Products') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-index', 'catalog') }}"><span>{{ __('Product Catalogs') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-index', 'without_image') }}"><span>{{ __('Without Image') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-index', 'without_details') }}"><span>{{ __('Without Details') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-index', 'featured') }}"><span>{{ __('Featured') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-index', 'latest') }}"><span>{{ __('Latest') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-index', 'without_category') }}"><span>{{ __('Without Category') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-index', 'active_without_image') }}"><span>{{ __('Active Without Image') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-prod-index', 'system_name') }}"><span>{{ __('With System Name') }}</span></a>
        </li>
    </ul>
</li>
...
@if(config("features.marketplace"))
    <li>
        <a href="{{ route('admin-subscription-index') }}" class=" wave-effect">
            <i class="fas fa-dollar-sign"></i>{{ __('Vendor Subscription Plans') }}
        </a>
    </li>
@endif
...
<li>
    <a href="#menu_brand" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="fas fa-apple-alt"></i>{{ __('Manage Brands') }}
    </a>
    <ul class="collapse list-unstyled" id="menu_brand" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-brand-index') }}"><span>{{ __('List Brands') }}</span></a>
            </li>
    </ul>
</li>
...
<li>
    <a href="#team_member" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="fas fa-fw fa-newspaper"></i>{{ __('Team') }}
    </a>
    <ul class="collapse list-unstyled" id="team_member" data-parent="#accordion">
        <li>
            <a href="{{ route('admin-cteam_member-index') }}"><span>{{ __('Categories') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-team_member-index') }}"><span>{{ __('Members') }}</span></a>
        </li>
    </ul>
</li>
...
<li>
    <a href="#stores" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
        <i class="fas fa-boxes"></i>{{ __('Manage Stores') }}
    </a>
    <ul class="collapse list-unstyled" id="stores" data-parent="#accordion">
        <li><a href="{{route('admin-stores-index')}}"><span>{{ __('Stores') }}</span></a></li>
    </ul>
</li>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('admin-shipping_prices-index') }}"><span>{{ __('Shipping Prices') }}</span></a>
        </li>
        <li>
            <a href="{{ route('admin-gs-correiosconf') }}"><span>{{ __('Correios') }}</span></a>
        </li>
        <li>
...
<li>
    <a href="{{ route('admin-bank_account-index') }}">
        <i class="fas fa-fw fa-newspaper"></i>{{ __('Bank Accounts') }}
    </a>
</li>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="seoTools" data-parent="#accordion">
        ...
        <li>
            <a href="{{ route('admin-seotool-fbpixel') }}"><span>{{ __('Facebook Pixel') }}</span></a>
        </li>
        <li>
...
<li>
    <a href="{{ route('admin-staff-index') }}" class=" wave-effect">
        <i class="fas fa-user-secret"></i>{{ __('Manage Staffs') }}
    </a>
</li>

<li>
    <a href="{{ route('admin-subs-index') }}" class=" wave-effect">
        <i class="fas fa-users-cog mr-2"></i>{{ __('Subscribers') }}
    </a>
</li>

<li>
    <a href="{{ route('admin-role-index') }}" class=" wave-effect">
        <i class="fas fa-user-tag"></i>{{ __('Manage Roles') }}
    </a>
</li>

<li>
    <a href="{{ route('admin-cache-clear') }}" class=" wave-effect">
        <i class="fas fa-sync"></i>{{ __('Clear Cache') }}
    </a>
</li>
