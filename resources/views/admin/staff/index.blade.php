        ...
        var table = $('#geniustable').DataTable({
            ...
            initComplete: function(settings, json) {
                $(".btn-area").append('<div class="col-sm-4 text-right">' +
                    '<a class="add-btn" data-href="{{ route('admin-staff-create') }}" data-header="{{ __('Add New Staff') }}" id="add-data" data-toggle="modal" data-target="#modal1">' +
