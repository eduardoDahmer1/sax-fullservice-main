...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Big Save') }} <i class="icofont-question-circle" data-toggle="tooltip"
                            data-placement="top" title="{{ __('Side banner that stay in the big-save section.') }}"
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-ps-best-seller') }}">{{ __('Big Save') }} </a>
                        </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="input-form">
                                            ...
                                            <div class="img-upload">
                                                <div id="image-preview" class="img-preview"
                                                    style="background: url({{ $admstore->pagesettings->big_save_banner ? asset('storage/images/banners/' . $admstore->pagesettings->big_save_banner) : asset('assets/images/noimage.png') }});">
                                                    <label for="image-upload" class="img-label" id="image-label"><i
                                                            class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                                    <input type="file" name="big_save_banner" class="img-upload"
                                                        id="image-upload">
                                                    @if ($admstore->pagesettings->big_save_banner)
                                                        <button type="button" class="btn btn-danger m-2 remove-banner"
                                                            tipo="big_save_banner">x</button>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-form">
                                            ...
                                            <input type="text" class="input-field" name="big_save_banner_link"
                                                placeholder="{{ __('Link') }}"
                                                value="{{ $admstore->pagesettings->big_save_banner_link }}">
                                        </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="input-form">
                                            ...
                                            <div class="img-upload">
                                                <div id="image-preview" class="img-preview"
                                                    style="background: url({{ $admstore->pagesettings->big_save_banner1 ? asset('storage/images/banners/' . $admstore->pagesettings->big_save_banner1) : asset('assets/images/noimage.png') }});">
                                                    <label for="image-upload" class="img-label" id="image-label"><i
                                                            class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                                    <input type="file" name="big_save_banner1" class="img-upload"
                                                        id="image-upload">
                                                    @if ($admstore->pagesettings->big_save_banner1)
                                                        <button type="button" class="btn btn-danger m-2 remove-banner"
                                                            tipo="big_save_banner1">x</button>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-form">
                                            ...
                                            <input type="text" class="input-field" name="big_save_banner_link1"
                                                placeholder="{{ __('Link') }}"
                                                value="{{ $admstore->pagesettings->big_save_banner_link1 }}">
                                        </div>
