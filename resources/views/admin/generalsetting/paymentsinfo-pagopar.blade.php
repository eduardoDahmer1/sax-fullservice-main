                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-2">
                                                <div class="input-form input-form-center">
                                                    ...
                                                    <div class="action-list">
                                                        <select
                                                            class="process select droplinks {{ $admstore->is_pagopar == 1 ? 'drop-success' : 'drop-danger' }}">
                                                            <option data-val="1"
                                                                value="{{ route('admin-gs-pagopar', 1) }}"
                                                                {{ $admstore->is_pagopar == 1 ? 'selected' : '' }}>
                                                                {{ __('Activated') }}</option>
                                                            <option data-val="0"
                                                                value="{{ route('admin-gs-pagopar', 0) }}"
                                                                {{ $admstore->is_pagopar == 0 ? 'selected' : '' }}>
                                            ...
                                            <div class="col-xl-5">
                                                <div class="input-form">
                                                    <h4 class="heading">{{ __('Pagopar Public Key') }} *
                                                        <span><i class="icofont-question-circle" data-toggle="tooltip"
                                                                data-placement="top"
                                                                title="{{ __('Consult your public key with the payment method provider.') }}"></i></span>
                                                    </h4>
                                                    <textarea class="input-field" name="pagopar_public_key" placeholder="{{ __('Pagopar Public Key') }}">{{ $admstore->pagopar_public_key }}</textarea>
                                            ...
                                            <div class="col-xl-5">
                                                <div class="input-form">
                                                    <h4 class="heading">{{ __('Pagopar Private Key') }} *
                                                        <span><i class="icofont-question-circle" data-toggle="tooltip"
                                                                data-placement="top"
                                                                title="{{ __('Consult your private key with the payment method provider.') }}"></i></span>
                                                    </h4>
                                                    <textarea class="input-field" name="pagopar_private_key" placeholder="{{ __('Pagopar Private Key') }}">{{ $admstore->pagopar_private_key }}</textarea>
                                                ...
                                                <div class="input-form">
                                                    @component('admin.components.input-localized', ['from' => $admstore, 'type' => 'textarea'])
                                                        ...
                                                        @slot('value')
                                                            pagopar_text
                                                        @endslot
                                                        {{ __('Pagopar Text') }} * <span><i class="icofont-question-circle"
