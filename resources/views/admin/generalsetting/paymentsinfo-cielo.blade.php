                                        ...
                                        <div class="row">
                                            <div class="col-xl-2">
                                                <div class="input-form input-form-center">
                                                    ...
                                                    <div class="action-list">
                                                        <select
                                                            class="process select droplinks {{ $admstore->is_cielo == 1 ? 'drop-success' : 'drop-danger' }}">
                                                            <option data-val="1" value="{{ route('admin-gs-cielo', 1) }}"
                                                                {{ $admstore->is_cielo == 1 ? 'selected' : '' }}>
                                                                {{ __('Activated') }}
                                                            </option>
                                                            <option data-val="0" value="{{ route('admin-gs-cielo', 0) }}"
                                                                {{ $admstore->is_cielo == 0 ? 'selected' : '' }}>
                                            ...
                                            <div class="col-xl-5">
                                                <div class="input-form">
                                                    <h4 class="heading">{{ __('Cielo MerchantId') }} *
                                                        <span><i class="icofont-question-circle" data-toggle="tooltip"
                                                                data-placement="top"
                                                                title="{{ __('Consult your Merchant ID (MID) with the payment method provider.') }}"></i></span>
                                                    </h4>
                                                    <textarea class="input-field" name="cielo_merchantid" placeholder="{{ __('Cielo MerchantId') }}">{{ $admstore->cielo_merchantid }}</textarea>
                                                ...
                                                <div class="input-form">
                                                    @component('admin.components.input-localized', ['from' => $admstore, 'type' => 'textarea'])
                                                        ...
                                                        @slot('value')
                                                            cielo_text
                                                        @endslot
                                                        {{ __('Cielo Text') }} * <span><i class="icofont-question-circle"
