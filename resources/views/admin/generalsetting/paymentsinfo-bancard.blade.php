                                        ...
                                        <div class="row">
                                                ...
                                                <div class="input-form input-form-center">
                                                    ...
                                                    <div class="action-list">
                                                        <select
                                                            ...
                                                            <option data-val="1"
                                                                value="{{ route('admin-gs-bancard', 1) }}"
                                                                {{ $admstore->is_bancard == 1 ? 'selected' : '' }}>
                                                                {{ __('Activated') }}
                                                            </option>
                                                            <option data-val="0"
                                                                value="{{ route('admin-gs-bancard', 0) }}"
                                            ...
                                            <div class="col-xl-6">
                                                <div class="input-form">
                                                    ...
                                                    <textarea class="input-field" name="bancard_public_key" placeholder="{{ __('Bancard Public Key') }}">{{ $admstore->bancard_public_key }}</textarea>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="input-form">
                                                    ...
                                                    <textarea class="input-field" name="bancard_private_key" placeholder="{{ __('Bancard Private Key') }}">{{ $admstore->bancard_private_key }}</textarea>
                                                </div>
                                            </div>
