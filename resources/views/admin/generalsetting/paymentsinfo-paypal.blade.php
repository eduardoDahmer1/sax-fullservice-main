                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4">
                                                <div class="input-form">
                                                    ...
                                                    <textarea class="input-field" name="paypal_secret" placeholder="{{ __('Secret') }}">{{ $admstore->paypal_secret }}</textarea>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="input-form">
                                                    ...
                                                    <textarea class="input-field" name="paypal_client_id" placeholder="{{ __('Client ID') }}">{{ $admstore->paypal_client_id }}</textarea>
