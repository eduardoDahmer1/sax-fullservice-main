                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-3">
                                                <div class="input-form input-form-center">
                                                    ...
                                                    <div class="action-list">
                                                        <select
                                                            class="process select droplinks {{ $admstore->is_jivochat == 1 ? 'drop-success' : 'drop-danger' }}">
                                                            <option data-val="1"
                                                                value="{{ route('admin-gs-jivochat', 1) }}"
                                                                {{ $admstore->is_jivochat == 1 ? 'selected' : '' }}>
                                                                {{ __('Activated') }}</option>
                                                            <option data-val="0"
                                                                value="{{ route('admin-gs-jivochat', 0) }}"
                                                                {{ $admstore->is_jivochat == 0 ? 'selected' : '' }}>
                                            ...
                                            <div class="col-xl-9">
                                                <div class="input-form">
                                                    <h4 class="heading">
                                                        {{ __('Jivochat Widget Code') }} *
                                                    </h4>
                                                    <div class="tawk-area">
                                                        <textarea name="jivochat">{{ $admstore->jivochat }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
