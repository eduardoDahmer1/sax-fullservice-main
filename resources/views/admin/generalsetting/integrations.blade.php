                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-4">
                                                <div class="input-form">
                                                    ...
                                                    <div class="action-list">
                                                        <select
                                                            class="process select droplinks {{ $admstore->is_talkto == 1 ? 'drop-success' : 'drop-danger' }}">
                                                            <option data-val="1" value="{{ route('admin-gs-talkto', 1) }}"
                                                                {{ $admstore->is_talkto == 1 ? 'selected' : '' }}>
                                                                {{ __('Activated') }}</option>
                                                            <option data-val="0" value="{{ route('admin-gs-talkto', 0) }}"
                                                                {{ $admstore->is_talkto == 0 ? 'selected' : '' }}>
                                            ...
                                            <div class="col-xl-8">
                                                <div class="input-form">
                                                    ...
                                                    <div class="tawk-area">
                                                        <textarea name="talkto">{{ $admstore->talkto }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
