                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3">
                                        <div class="left-area">
                                            ...
                                            <small>(This background will be displayed if vendor dosen't set his / her store
                                                background)</small>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="input-group colorpicker-component cp">
                                                <input type="text" class="input-field color-field" name="vendor_color"
                                                    value="{{ $gs->vendor_color }}" class="form-control cp" />
