    ...
    <div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-center">
                        {{ __('You are about to delete this Vendor. Every informtation under this vendor will be deleted.') }}
                    </p>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).on('click', '.verify', function() {
            ...
            $('#verify-modal .modal-content .modal-body').html('').load($(this).attr('data-href'), function(
                response, status, xhr) {
                if (status == "success") {
                    if (admin_loader == 1) {
                        $('.submit-loader').hide();
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', 'a', function(e) {
                ...
                if (link.attr("href").indexOf("vendors/withdraws") > -1) {
                    sessionStorage.setItem("CurrentPage", 0);
                    table.state.clear();
                }
                if (!(link.attr("data-href") || link.attr("href").indexOf("#") > -1 || link.attr("href")
                        .indexOf("javascript") > -1 || link.attr("href").indexOf("vendors/subs") > -1 ||
                        link.attr("href").indexOf("vendors") > -1)) {
                    sessionStorage.setItem("CurrentPage", 0);
                    table.state.clear();
                }
            });
