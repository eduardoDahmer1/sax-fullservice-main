                                                                ...
                                                                <div class="tab-content">
                                                                    <div class="tab-pane active" role="tabpanel"
                                                                        ...
                                                                        <textarea class="form-control" name="{{ $lang->locale }}[title_text]" id="title_text_in_{{ $lang->locale }}"
                                                                            rows="5" placeholder="{{ __('Enter Title Text') }}">{{ $data->title_text ?? '' }}</textarea>
                                                                    </div>
                                                                    @foreach ($locales as $loc)
                                                                        ...
                                                                        <div class="tab-pane" role="tabpanel"
                                                                            ...
                                                                            <textarea class="form-control" name="{{ $loc->locale }}[title_text]" id="title_text_in_{{ $loc->locale }}"
                                                                                rows="5" placeholder="{{ __('Enter Title Text') }}">{{ $data->translate($loc->locale)->title_text ?? '' }}</textarea>
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <select class="form-control" id="title_anime"
                                                                    name="title_anime">
                                                                    <option value="fadeIn"
                                                                        {{ $data->title_anime == 'fadeIn' ? 'selected' : '' }}>
                                                                        fadeIn</option>
                                                                    <option value="fadeInDown"
                                                                        {{ $data->title_anime == 'fadeInDown' ? 'selected' : '' }}>
                                                                        fadeInDown</option>
                                                                    <option value="fadeInLeft"
                                                                        {{ $data->title_anime == 'fadeInLeft' ? 'selected' : '' }}>
                                                                        fadeInLeft</option>
                                                                    <option value="fadeInRight"
                                                                        {{ $data->title_anime == 'fadeInRight' ? 'selected' : '' }}>
                                                                        fadeInRight</option>
                                                                    <option value="fadeInUp"
                                                                        {{ $data->title_anime == 'fadeInUp' ? 'selected' : '' }}>
                                                                        fadeInUp
                                                                    </option>
                                                                    <option value="flip"
                                                                        {{ $data->title_anime == 'flip' ? 'selected' : '' }}>
                                                                        flip</option>
                                                                    <option value="flipInX"
                                                                        {{ $data->title_anime == 'flipInX' ? 'selected' : '' }}>
                                                                        flipInX
                                                                    </option>
                                                                    <option value="flipInY"
                                                                        {{ $data->title_anime == 'flipInY' ? 'selected' : '' }}>
                                                                        flipInY
                                                                    </option>
                                                                    <option value="slideInUp"
                                                                        {{ $data->title_anime == 'slideInUp' ? 'selected' : '' }}>
                                                                        slideInUp
                                                                    </option>
                                                                    <option value="slideInDown"
                                                                        {{ $data->title_anime == 'slideInDown' ? 'selected' : '' }}>
                                                                        slideInDown</option>
                                                                    <option value="slideInLeft"
                                                                        {{ $data->title_anime == 'slideInLeft' ? 'selected' : '' }}>
                                                                        slideInLeft</option>
                                                                    <option value="slideInRight"
                                                                        {{ $data->title_anime == 'slideInRight' ? 'selected' : '' }}>
                                                                        slideInRight</option>
                                                                    <option value="rollIn"
                                                                        {{ $data->title_anime == 'rollIn' ? 'selected' : '' }}>
                                                                        rollIn</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="tab-content">
                                                                    <div class="tab-pane active" role="tabpanel"
                                                                        ...
                                                                        <textarea class="form-control" name="{{ $lang->locale }}[subtitle_text]" id="subtitle_text_in_{{ $lang->locale }}"
                                                                            rows="5" placeholder="{{ __('Enter Title Text') }}">{{ $data->subtitle_text ?? '' }}</textarea>
                                                                    </div>
                                                                    @foreach ($locales as $loc)
                                                                        @if ($loc->locale === $lang->locale)
                                                                            @continue
                                                                        ...
                                                                        <div class="tab-pane" role="tabpanel"
                                                                            ...
                                                                            <textarea class="form-control" name="{{ $loc->locale }}[subtitle_text]" id="subtitle_text_in_{{ $loc->locale }}"
                                                                                rows="5" placeholder="{{ __('Enter Title Text') }}">{{ $data->translate($loc->locale)->subtitle_text ?? '' }}</textarea>
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <select class="form-control" id="subtitle_anime"
                                                                    ...
                                                                    <option value="flip"
                                                                        {{ $data->subtitle_anime == 'flip' ? 'selected' : '' }}>
                                                                        flip</option>
                                                                    <option value="flipInX"
                                                                ...
                                                                <div class="tab-content">
                                                                    <div class="tab-pane active" role="tabpanel"
                                                                        ...
                                                                        <textarea class="form-control" name="{{ $lang->locale }}[details_text]" id="details_text_in_{{ $lang->locale }}"
                                                                            rows="5" placeholder="{{ __('Enter Title Text') }}">{{ $data->details_text ?? '' }}</textarea>
                                                                    </div>
                                                                    @foreach ($locales as $loc)
                                                                        @if ($loc->locale === $lang->locale)
                                                                            @continue
                                                                        ...
                                                                        <div class="tab-pane" role="tabpanel"
                                                                            ...
                                                                            <textarea class="form-control" name="{{ $loc->locale }}[details_text]" id="details_text_in_{{ $loc->locale }}"
                                                                                rows="5" placeholder="{{ __('Enter Title Text') }}">{{ $data->translate($loc->locale)->details_text ?? '' }}</textarea>
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <select class="form-control" id="details_anime"
                                                                    name="details_anime">
                                                                    <option value="fadeIn"
                                                                        {{ $data->details_anime == 'fadeIn' ? 'selected' : '' }}>
                                                                        fadeIn</option>
                                                                    <option value="fadeInDown"
                                                                        {{ $data->details_anime == 'fadeInDown' ? 'selected' : '' }}>
                                                                        fadeInDown</option>
                                                                    <option value="fadeInLeft"
                                                                        {{ $data->details_anime == 'fadeInLeft' ? 'selected' : '' }}>
                                                                        fadeInLeft</option>
                                                                    <option value="fadeInRight"
                                                                        {{ $data->details_anime == 'fadeInRight' ? 'selected' : '' }}>
                                                                        fadeInRight</option>
                                                                    <option value="fadeInUp"
                                                                        {{ $data->details_anime == 'fadeInUp' ? 'selected' : '' }}>
                                                                        fadeInUp
                                                                    </option>
                                                                    <option value="flip"
                                                                        {{ $data->details_anime == 'flip' ? 'selected' : '' }}>
                                                                        flip</option>
                                                                    <option value="flipInX"
                                                                        {{ $data->details_anime == 'flipInX' ? 'selected' : '' }}>
                                                                        flipInX
                                                                    </option>
                                                                    <option value="flipInY"
                                                                        {{ $data->details_anime == 'flipInY' ? 'selected' : '' }}>
                                                                        flipInY
                                                                    </option>
                                                                    <option value="slideInUp"
                                                                        {{ $data->details_anime == 'slideInUp' ? 'selected' : '' }}>
                                                                        slideInUp
                                                                    </option>
                                                                    <option value="slideInDown"
                                                                        {{ $data->details_anime == 'slideInDown' ? 'selected' : '' }}>
                                                                        slideInDown</option>
                                                                    <option value="slideInLeft"
                                                                        {{ $data->details_anime == 'slideInLeft' ? 'selected' : '' }}>
                                                                        slideInLeft</option>
                                                                    <option value="slideInRight"
                                                                        {{ $data->details_anime == 'slideInRight' ? 'selected' : '' }}>
                                                                        slideInRight</option>
                                                                    <option value="rollIn"
                                                                        {{ $data->details_anime == 'rollIn' ? 'selected' : '' }}>
                                                                        rollIn</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="input-form">
                                            ...
                                            <div class="img-upload full-width-img">
                                                <div id="image-preview" class="img-preview"
                                                    style="background: url('{{ $data->photo ? asset('storage/images/sliders/' . $data->photo) : asset('assets/images/noimage.png') }}');">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="input-form">
                                            ...
                                            <select name="position" required="">
                                                ...
                                                <option value="slide-one"
                                                    {{ $data->position == 'slide-one' ? 'selected' : '' }}>
                                                    {{ __('Left') }}
                                                </option>
                                                <option value="slide-two"
                                                    {{ $data->position == 'slide-two' ? 'selected' : '' }}>
                                                    {{ __('Center') }}
                                                </option>
                                                <option value="slide-three"
                                                    {{ $data->position == 'slide-three' ? 'selected' : '' }}>
                                                    {{ __('Right') }}</option>
                                            </select>
                                        </div>
                                    </div>
