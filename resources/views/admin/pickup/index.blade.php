                            ...
                            <table id="example" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><i class="icofont-location-pin icofont-lg" data-toggle="tooltip"
                                                title='{{ __('Location') }}'></i></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
        ...
        var table = $('#example').DataTable({
            ...
            initComplete: function(settings, json) {
                $(".btn-area").append('<div class="col-sm-4 text-right">' +
                    '<a class="add-btn" data-href="{{ route('admin-pick-create') }}" data-header="{{ __('Add New Pickup Location') }}" id="add-data" data-toggle="modal" data-target="#modal1">' +
