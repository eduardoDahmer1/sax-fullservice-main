                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="facebook" id="facebook"
                            placeholder="{{ __('https://facebook.com/') }}" required="" type="text"
                            value="{{ $data->facebook }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="twitter" id="twitter"
                            placeholder="{{ __('https://twitter.com/') }}" required="" type="text"
                            value="{{ $data->twitter }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="linkedin" id="linkedin"
                            placeholder="{{ __('https://linkedin.com/') }}" required="" type="text"
                            value="{{ $data->linkedin }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="youtube" id="youtube"
                            placeholder="{{ __('https://youtube.com/') }}" required="" type="text"
                            value="{{ $data->youtube }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="instagram" id="instagram"
                            placeholder="{{ __('https://instagram.com/') }}" required="" type="text"
