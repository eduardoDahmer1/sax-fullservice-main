                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-partner-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="col-xl-6">
                            <div class="input-form">
                                ...
                                <input type="text" class="input-field" name="link" placeholder="{{ __('Link') }}" value="" required>
                            </div>
                          </div>
                        ...
                        <div class="row justify-content-center">
                            <button class="addProductSubmit-btn mt-4" type="submit">{{ __('Create Logo') }}</button>
