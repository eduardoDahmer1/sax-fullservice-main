...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('General Shipping') }}</h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="{{ route('admin-shipping-index') }}">{{ __('General Shipping') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        var table = $('#geniustable').DataTable({
            ...
            drawCallback: function(settings) {
                ...
                $(".checkboxStatus").on('click', function() {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '{{ url('admin/shipping/status') }}' + '/' + id + '/' + statusNovo
                    });
                });
            },
            initComplete: function(settings, json) {
                $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                    '<a class="add-btn" data-href="{{ route('admin-shipping-create') }}" data-header="{{ __('Add New Shipping Method') }}" id="add-data" data-toggle="modal" data-target="#modal1">' +
