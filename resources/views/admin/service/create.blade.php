      ...
      <div class="col-lg-12">
        <div class="product-description">
          <div class="body-area">
            ...
            <form id="geniusformdata" action="{{route('admin-service-create')}}" method="POST"
                ...
                <div class="col-xl-6">
                  <div class="input-form">
                    ...
                    <div class="img-upload">
                      <div style="width:180px;background-image: url( {{ asset('assets/admin/images/quadriculado.jpg')}} );background-size:contain;">
                        <div id="image-preview" class="img-preview"
                          style="background-image: url('{{ asset('assets/admin/images/upload.png') }}');background-size:100% !important;background-position:center !important;">
