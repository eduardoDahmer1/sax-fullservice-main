        ...
        var table = $('#geniustable').DataTable({
            ...
            drawCallback: function(settings) {
                ...
                $(".checkboxStatus").on('click', function() {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '{{ url('admin/subcategory/status') }}' + '/' + id + '/' +
                            statusNovo
                    });
            ...
            initComplete: function(settings, json) {
                $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                    '<a class="add-btn" data-href="{{ route('admin-subcat-create') }}" data-header="{{ __('Add New Sub Category') }}" id="add-data" data-toggle="modal" data-target="#modal1">' +
