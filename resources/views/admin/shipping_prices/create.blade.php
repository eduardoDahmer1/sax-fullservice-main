      ...
      <div class="col-lg-12">
        <div class="product-description">
          <div class="body-area">
            ...
            <form id="geniusformdata" action="{{route('admin-shipping_prices-create')}}" method="POST"
              ...
              <div class="row">
                ...
                <div class="col-lg-7">
                  <input type="number" class="input-field" name="price" placeholder="{{ __('Price') }}" value="" min="0"
                    step="0.01">
                </div>
              </div>
