...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Edit Extras') }} <a class="add-btn" href="{{ route('admin-lang-index') }}"><i
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-lang-extras', $data->id) }}">{{ __('Extras') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-lang-update-extras', $data->id) }}" method="POST"
                                ...
                                <h4 class="text-center">{{ __('SET LANGUAGE KEYS & VALUES') }} - {{ $data->language }}
                                </h4>
