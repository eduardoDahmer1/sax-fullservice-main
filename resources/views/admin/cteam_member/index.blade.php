            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-cteam_member-index') }}">{{ __('Categories') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
@section('scripts')
    <script type="text/javascript">
        var table = $('#example').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin-cteam_member-datatables') }}',
            columns: [{
                    data: 'action',
                    searchable: false,
                    orderable: false
            ...
            initComplete: function(settings, json) {
                $(".btn-area").append('<div class="col-sm-4 text-right">' +
                    '<a class="add-btn" data-href="{{ route('admin-cteam_member-create') }}" data-header="{{ __('Add New Category') }}" id="add-data" data-toggle="modal" data-target="#modal1">' +
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', 'a', function(e) {
                ...
                if (!(link.attr("data-href") || link.attr("href").indexOf("#") > -1 || link.attr("href")
                        .indexOf("javascript") > -1 || !(link.attr("href").indexOf("team_member/category"))
                        )) {
                    sessionStorage.setItem("CurrentPage", 0);
                    table.state.clear();
                }
