            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-sb-large') }}">{{ __('Large') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        var table = $('#geniustable').DataTable({
            ...
            initComplete: function(settings, json) {
                $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                    '<a class="add-btn" data-href="{{ route('admin-sb-create-large') }}" data-header="{{ __('Add New Banner') }}" id="add-data" data-toggle="modal" data-target="#modal1">' +
