        ...
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <h4 class="heading">{{ __('Conversation with') }} {{ $conv->user->name }} <a class="add-btn"
                            href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                    <ul class="links">
                        <li>
                            <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                        </li>
                        @if (strtolower($conv->type) === 'ticket')
                            <li>
                                <a href="{{ route('admin-message-index') }}">{{ __('Tickets') }}</a>
                            </li>
                        @else
                            <li>
                                <a href="{{ route('admin-message-dispute') }}">{{ __('Disputes') }}</a>
                            </li>
                        @endif
                        <li>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="reply-area">
                                            <div class="left">
                                                <img class="img-circle"
                                                    src="{{ Auth::guard('admin')->user()->photo ? asset('storage/images/admins/' . Auth::guard('admin')->user()->photo) : asset('assets/images/noimage.png') }}"
                                                    alt="">
                                                <p class="ticket-date">
                                                    @php
                                                        \Carbon\Carbon::setLocale($lang->locale);
                ...
                <div class="panel-footer">
                    <form id="messageform" action="{{ route('admin-message-store') }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="message" id="wrong-invoice" rows="5" required=""
