                        ...
                        <div class="order-history">
                            <div class="header-area">
                                <h4 class="title">
                                    ...
                                    @else
                                        {{ $conv->sent->name }}
                                    @endif <a class="mybtn1" href="{{ route('user-messages') }}"> <i
                            ...
                            <div class="support-ticket-wrapper ">
                                <div class="panel panel-primary">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="reply-area">
                                                                <div class="left">
                                                                    ...
                                                                    @else
                                                                        <img class="img-circle"
                                                                            src="{{ $message->conversation->sent->photo != null ? asset('storage/images/users/' . $message->conversation->sent->photo) : asset('assets/images/noimage.png') }}"
                                                                            alt="">
                                                                    @endif
                                                                    <p class="ticket-date">
                                                                        {{ $message->conversation->sent->name }}
                                                                    </p>
                                                                </div>
                                                                <div class="right">
                                                                    <p>{{ $message->message }}</p>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="reply-area">
                                                                ...
                                                                <div class="right">
                                                                    ...
                                                                    @else
                                                                        <img class="img-circle"
                                                                            src="{{ $message->conversation->recieved->photo != null ? asset('storage/images/users/' . $message->conversation->recieved->photo) : asset('assets/images/noimage.png') }}"
                                                                            alt="">
                                                                    @endif
                                                                    <p class="ticket-date">
                                                                        {{ $message->conversation->recieved->name }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="panel-footer">
                                        <form id="messageform"
                                            data-href="{{ route('user-vendor-message-load', $conv->id) }}"
                                            action="{{ route('user-message-post') }}" method="POST">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if ($user->id == $conv->sent_user)
                                                    ...
                                                    <input type="hidden" name="reciever"
                                                        value="{{ $conv->recieved->id }}">
                                                @else
                                                    <input type="hidden" name="reciever" value="{{ $conv->sent->id }}">
                                                    <input type="hidden" name="recieved_user"
                                                        value="{{ $conv->recieved->id }}">
                                                @endif
