                    ...
                    <div class="user-profile-details">
                        <div class="order-history">
                            <div class="header-area">
                                <h4 class="title">
                                    {{ __('Disputes') }} <a data-toggle="modal" data-target="#vendorform" class="mybtn1"
                                        href="javascript:;"> <i class="fas fa-envelope"></i> {{ __('Add Dispute') }}</a>
                                </h4>
                            </div>
                                                ...
                                                <tr class="conv">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="javascript:;" data-toggle="modal"
                                                            ...
                                                            data-href="{{ route('user-message-delete1', $conv->id) }}"class="link remove"><i
                                ...
                                <div class="col-md-12">
                                    <div class="contact-form">
                                        <form id="emailreply1">
                                            ...
                                            <ul>
                                                <li>
                                                    <input type="text" class="input-field" id="order"
                                                        name="order_numkber" placeholder="{{ __('Order Number') }} *"
                                                        required="">
                                                </li>
        ...
        $(document).on("submit", "#emailreply1", function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data == 0)
                        toastr.error("{{ __('Oops Something Goes Wrong !!') }}");
                    else
