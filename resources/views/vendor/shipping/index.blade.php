            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('vendor-shipping-index') }}">{{ __('Shipping Methods') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var table = $('#geniustable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('vendor-shipping-datatables') }}',
            columns: [{
                    data: 'title',
                    name: 'title'
                },
            ...
            initComplete: function(settings, json) {
                $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                    '<a class="add-btn" data-href="{{ route('vendor-shipping-create') }}" id="add-data" data-toggle="modal" data-target="#modal1">' +
