        ...
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        <li>
                            <a href="{{ route('vendor-import-index') }}">{{ __('Dashbord') }} </a>
                        </li>
                        <li>
                            <a href="javascript:;">{{ __('Affiliate Products') }} </a>
                        </li>
                        <li>
                            <a href="{{ route('vendor-import-index') }}">{{ __('All Affiliate Products') }}</a>
                        </li>
                        <li>
                            ...
                            <form id="geniusform" action="{{ route('vendor-import-update', $data->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="input-form {{ !empty($data->size) ? '' : ' showbox' }}"
                                            id="size-display">
                                            <div class="row">
                                                <div class="col-xl-12">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="checkbox-wrapper list list-personalizada">
                                                    <input type="checkbox" name="seo_check" value="1"
                                                        class="checkclick1" id="allowProductSEO" value="1"
