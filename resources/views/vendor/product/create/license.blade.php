                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('vendor-prod-store') }}" method="POST"
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview"
                                                ...
                                                <input type="file" name="photo" class="img-upload-p"
                                        ...
                                        <div class="featured-keyword-area">
                                            ...
                                            <div class="feature-tag-top-filds" id="license-section">
                                                <div class="license-area">
                                                    <span class="remove license-remove"><i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="text-editor">
                                            <textarea name="details" class="trumboedit-p"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="text-editor">
                                            <textarea name="policy" class="trumboedit-p"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field"
                                            placeholder="{{ __(' Product Platform') }}" name="platform">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field"
                                            placeholder="{{ __(' Product Region') }}" name="region">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field"
                                            placeholder="{{ __(' License Type') }}" name="licence_type">
                                    </div>
                                </div>
