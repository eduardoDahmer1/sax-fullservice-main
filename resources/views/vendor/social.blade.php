        ...
        <div class="social-links-area">
            ...
            <form id="geniusform" class="form-horizontal" action="{{ route('vendor-social-update') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="f_url" id="facebook" placeholder="{{ __(' Facebook') }}"
                            required="" type="text" value="{{ $data->f_url }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="t_url" id="twitter" placeholder="{{ __(' Twitter') }}"
                            required="" type="text" value="{{ $data->t_url }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" name="l_url" id="linkedin" placeholder="{{ __(' Linkedin') }}"
                            required="" type="text" value="{{ $data->l_url }}">
                    </div>
                    <div class="col-sm-3">
                        <label class="switch">
