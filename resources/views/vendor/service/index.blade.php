            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('vendor-service-index') }}">{{ __('Services') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        var table = $('#geniustable').DataTable({
            ...
            initComplete: function(settings, json) {
                $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                    '<a class="add-btn" data-href="{{ route('vendor-service-create') }}" data-header="{{ __('Add New Service') }}" id="add-data" data-toggle="modal" data-target="#modal1">' +
