        ...
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">{{ __("Order Invoice") }} <a class="add-btn"
                        href="{{ route('vendor-order-show',$order->id) }}"><i class="fas fa-arrow-left"></i> {{
                        __("Back") }}</a></h4>
                <ul class="links">
                    <li>
                    ...
                    <li>
                        <a href="javascript:;">{{ __("Order Invoice") }}</a>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="table-responsive">
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p>
                                                    ...
                                                    round($product['item']['price'] * $order->currency_value , 2) }}
                                                </p>
                                                <p>
                                            ...
                                            <td>{{$order->currency_sign}}{{ round($product['price'] *
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="2">{{ Shipping::where('price','=',$price)->first()->title
                                        ...
                                        <tr>
                                            <td colspan="2">{{ Package::where('price','=',$pprice)->first()->title
                                                }}({{$order->currency_sign}})</td>
