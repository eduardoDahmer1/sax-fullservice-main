                                ...
                                @if (Auth::user()->id == $order->vendor_shipping_id)
                                    @if ($order->shipping_cost != 0)
                                        ...
                                        @if (Shipping::where('price', '=', $price)->count() > 0)
                                            <tr class="no-border">
                                                <td colspan="1"></td>
                                                <td><strong>{{ Shipping::where('price', '=', $price)->first()->title }}({{ $order->currency_sign }})</strong>
                                                </td>
                                ...
                                @if (Auth::user()->id == $order->vendor_packing_id)
                                    @if ($order->packing_cost != 0)
                                        ...
                                        @if (Package::where('price', '=', $pprice)->count() > 0)
                                            <tr class="no-border">
                                                <td colspan="1"></td>
                                                <td><strong>{{ Package::where('price', '=', $pprice)->first()->title }}({{ $order->currency_sign }})</strong>
                                                </td>
