...
(function($) {
  ...
  $.fn.simpleCropper = function(config) {
    if (!config) {
      config = {};
    }
    ...
    var ias = null;
    var jcrop_api;
    var bottom_html = "<input type='file' id='fileInput'/> <canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='moveUp'></div><div class='moveRigth'></div><div class='moveDown'></div><div class='moveLeft'></div><div class='zoomIn'></div><div class='zoomOut'></div><div class='cancel'></div><div class='ok'></div></div></div>";
        ...
        reader.onload = function(e) {
          ...
          current_image.onload = function() {
            ...
            setTimeout(()=>{
              ...
              ias = new Cropper(image, {
                aspectRatio: (config.landscape ? 16/9 : 1/1),
                zoomOnWheel: false
              });
            },600);
          }
