...
.seller-info .view-stor {
    ...
    border: solid 1px <?php echo $text_color_1; ?> !important;
}

.seller-info .view-stor:hover {
    color: <?php echo $theme_color_1; ?> !important;
    background: <?php echo $text_color_1; ?> !important;
    border-color: <?php echo $theme_color_1; ?> !important;
}

.product-details-page .right-area .product-info .info-meta-3 .meta-list li.addtocart a {
    color: <?php echo $text_color_1; ?>;
    background: <?php echo $theme_color_1; ?>;
    border: solid 1px <?php echo $text_color_1; ?>;
}
...
.contact-us .right-area .social-links ul li a.linkedin:hover {
    color: #0077B5 !important;
    border: solid 1px #0077B5 !important;
    background: #ffff !important;
}

.contact-us .right-area .social-links ul li a.instagram:hover {
    color: #cc2366 !important;
    border: solid 1px #cc2366 !important;
    background: #ffff !important;
}

.contact-us .right-area .social-links ul li a.facebook:hover {
    color: #3b5999 !important;
    border: solid 1px #3b5999 !important;
    background: #ffff !important;
}
...
.bottomtotop i:hover {
    ...
    border: solid 1px <?php echo $text_color_2; ?> ;
}
...
html body div.core-content section.hot-and-new-item div.container div.row div.col-lg-12 div.accessories-slider div.slide-item div.row div.col-lg-12.col-sm-6 div.categori .section-top .section-title::after {
    background: <?php echo $theme_color_1; ?> !important;
}
...
html body div.core-content div.menufixed div.mainmenu-area.mainmenu-bb {
    background: <?php echo $theme_color_1; ?> !important;
}
...
.item:hover {
border:2px solid <?php echo $theme_color_1; ?> !important;
}
