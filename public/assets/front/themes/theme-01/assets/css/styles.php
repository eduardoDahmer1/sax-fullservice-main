...
html body div.core-content div.mainmenu-area.mainmenu-bb div.container div.row.align-items-center.mainmenu-area-innner div.col-lg-9.col-md-6.mainmenu-wrapper.remove-padding nav.core-nav div.full-container div.wrap-core-nav-list.right ul.menu.core-nav-list li > *{
...
html body div.core-content section.top-header div.container div.row div.col-lg-12.remove-padding div.content div.right-content div.list ul li.login a.sign-log div.links {
    color: <?php echo $text_color_1; ?>;
}
...
background: <?php echo $theme_color_1; ?>;
border-color: <?php echo $theme_color_1; ?>; }
.product-details-page .right-area .product-info .product-price .price > span{
color: <?php echo $theme_color_1; ?>;
text-shadow: 0 0 4px <?php echo $text_color_1; ?>;}
.product-details-page .right-area .product-info .product-size .siz-list li.active .box {
...
.item-vendor .item-img .extra-list ul li span:hover {
background: <?php echo $text_color_1; ?>;
...
.btn.btn-primary.btn-backinstock {
    color: <?php echo $text_color_1; ?>;
    background-color: <?php echo $theme_color_1; ?>;
    border: 1px solid <?php echo $text_color_1; ?>;
}
...
.btn.btn-primary.btn-backinstock:hover {
    color: <?php echo $theme_color_1; ?>;
    background-color: <?php echo $text_color_1; ?>;
    border: 1px solid <?php echo $theme_color_1; ?>;
}
