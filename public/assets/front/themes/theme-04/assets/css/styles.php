...
html body div.core-content section.top-header div.container div.row div.col-lg-12.remove-padding div.content div.left-content div.list ul li.separador-right div.language-selector div.nice-select.language.selectors.nice span.current {
    color: <?php echo $text_color_1; ?> !important;
}

.top-header .left-content .list ul li .nice-select::after {
    border-bottom: 2px solid <?php echo $text_color_1; ?> !important;
    border-right: 2px solid <?php echo $text_color_1; ?> !important;
}
...
html body div.core-content section.top-header div.container div.row div.col-lg-12.remove-padding div.content div.right-content div.list ul li div.currency-selector div.nice-select.currency.selectors.nice span.current {
    color: <?php echo $text_color_1; ?>;
}

html body div.core-content footer#footer.footer div.container div.row.justify-content-around div.col-12.col-md-4.d-flex.flex-column.justify-content-start.align-items-center div.footer-info-area h4.title {
    color: <?php echo $text_color_1; ?>;
}
...
html body div.core-content section.top-header div.container div.row div.col-lg-12.remove-padding div.content div.right-content div.list ul li a span.text {
...
.footer .fotter-social-links ul li a {
    color: <?php echo $text_color_2; ?> !important;
    border-color: <?php echo $text_color_2; ?> !important;
}

.footer .fotter-social-links ul li a:hover {
    background: <?php echo $text_color_2; ?> !important;
    color: <?php echo $theme_color_2; ?> !important;
}

html body div.core-content footer#footer.footer div.container div.row.justify-content-around div.col-md-3 div.footer-widget.info-link-widget ul.link-list li a {
    color: <?php echo $text_color_2; ?> !important;
}

.footer .footer-info-area .text p, .footer .footer-widget ul li a, .recent-post-widget .post-list li .post .post-details .post-title, .recent-post-widget .post-list li .post .post-details .date, .footer .footer-widget .title {
    color: <?php echo $text_color_2; ?> !important;
}

html body div.core-content footer#footer.footer div.container div.row.justify-content-around div.col-md-3 div.footer-widget.info-link-widget ul.link-list li a:hover {
    color: #fff !important;
}
...
.item:hover {
    box-shadow: 0 0px 14px -2px <?php echo $theme_color_1; ?> !important;
    -o-box-shadow: 0 0px 14px -2px <?php echo $theme_color_1; ?> !important;
    -webkit-box-shadow: 0 0px 14px -2px <?php echo $theme_color_1; ?> !important;
    -moz-box-shadow: 0 0px 14px -2px <?php echo $theme_color_1; ?> !important;
}

.item {
    box-shadow: 0 0px 4px -2px <?php echo $theme_color_1; ?>;
}
...
.svg-button path, .svg-header path {
    stroke: <?php echo $theme_color_1; ?> ;
}

.categories_menu .svg-button path{
    fill: <?php echo $theme_color_1; ?>;
}

.item .extra-list ul li span {
    color: <?php echo $theme_color_2; ?>;
}

.blog-area .aside .slider-wrapper .slide-item .review-text:after, .blog-area .aside .slider-wrapper .slide-item .review-text:before {
    color:  <?php echo $theme_color_1; ?>;
}
...
.login-area .social-area .social-links li a i.fa-facebook-f, .login-area .social-area .social-links li a i.google {
    background-color: <?php echo $theme_color_2 ?>;
}
...
.login-area .form-input input::placeholder {
    color: <?php echo $theme_color_1 ?>;
}
...
.contact-us .left-area .contact-form .form-input input::placeholder {
    color: <?php echo $theme_color_1 ?>;
}
...
.contact-us .left-area .contact-form .form-input textarea::placeholder {
    color: <?php echo $theme_color_1 ?>;
}
...
.blog-area .owl-carousel .owl-item img {
    border: 1px solid <?php echo $theme_color_1; ?>;
    box-shadow: 0 0 7px <?php echo $theme_color_1; ?>;
}
