...
.flash-deals .flas-deal-slider .deal-counter span, .flash-deals .flas-deal-slider .deal-counter span small {
    color: <?php echo $theme_color_2; ?>;
    transition: all .4s;
}

.flash-deals .flas-deal-slider .card-product-flash:hover .deal-counter span, .flash-deals .flas-deal-slider .card-product-flash:hover .deal-counter span small {
    color: <?php echo $text_color_2; ?>;
    transition: all .4s;
}
