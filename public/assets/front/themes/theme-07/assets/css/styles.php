...
.top-header ul li.my-dropdown.profilearea  .profile .text, .top-header .left-content .list ul li .currency-selector span {
    color: <?php echo $text_color_2; ?> !important;
}

.separador-right {
    border-right: 1px solid <?php echo $text_color_2; ?>;
}

.separador-left {
    border-left: 1px solid <?php echo $text_color_2; ?>;
}
