...
.item:hover {
    box-shadow: 0 0px 8px -2px <?php echo $theme_color_1; ?> !important;
    -o-box-shadow: 0 0px 8px -2px <?php echo $theme_color_1; ?> !important;
    -webkit-box-shadow: 0 0px 8px -2px <?php echo $theme_color_1; ?> !important;
    -moz-box-shadow: 0 0px 8px -2px <?php echo $theme_color_1; ?> !important;
}
