...
.right-content .nice-select::after {
    border-bottom: 2px solid <?php echo $theme_color_2; ?>;
    border-right: 2px solid <?php echo $theme_color_2; ?>;
}
...
.menu-lateral-categorias {
    background-color: <?php echo $theme_color_2; ?>eb;
}
...
.mainmenu-area-innner {
    border-top: .5px solid <?php echo $text_color_2; ?>21;
}
...
.logo-header .search-box.open-search {
    border: 2px solid <?php echo $text_color_2; ?>;
    background-color: <?php echo $theme_color_2; ?>;
}
