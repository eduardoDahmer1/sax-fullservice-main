            ...
            ->addColumn('action', function (Rating $data) {
				...
				<div class="godropdown">
					...
					<div class="action-list">
						<a data-href="' . route('admin-rating-show', $data->id) . '" data-header="' . __('Details') . '" class="view" data-toggle="modal" data-target="#modal1">
							<i class="fas fa-eye"></i> '. __('Details') . '
						</a>
						<a href="javascript:;" data-href="' . route('admin-rating-delete', $data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete">
